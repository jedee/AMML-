...
import { SettingsView } from '../components/amml/SettingsView';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 font-mono select-none">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold text-amml-green uppercase tracking-widest">Global Policy configurations</span>
          </div>
          <h1 className="text-lg font-bold text-white tracking-wider mt-1.5 uppercase">Lateness margins Coefficients</h1>
        </div>
        
        <div className="flex items-center gap-2 text-xs text-amml-muted bg-amml-panel border border-amml-line px-3 py-1.5 rounded">
          <Settings2 className="h-4 w-4 text-amml-green" />
          <span>POLICIES LOCK: MASTER STATUS</span>
        </div>
      </div>
